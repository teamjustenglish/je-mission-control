  ...
  return (
    <TooltipProvider delayDuration={250}>
      <Tooltip
        open={open}
        onOpenChange={(val) => {
          // When click-locked, ignore hover/focus close signals so the tooltip
          // stays pinned open until the user clicks the icon again.
          if (!val && locked.current) return;
          setOpen(val);
        }}
      >
